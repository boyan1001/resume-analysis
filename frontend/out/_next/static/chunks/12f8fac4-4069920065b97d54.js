    ...
    7952: (t, e, i) => {
      ...
      class y {
        ...
        _resolveElementOptions(t, e = "default", i) {
          ...
          return (
            p.$shared && ((p.$shared = l), (n[r] = Object.freeze(_(p, l)))),
            p
          );
        }
        ...
        _calculateBarIndexPixels(t, e) {
          ...
          if (e.grouped) {
            let n = o ? this._getStackCount(t) : e.stackCount,
              ...
              u = this._getAxis().indexOf(
                (0, s.v)(c, this.getFirstScaleIdForIndexAxis()),
              ),
              g =
                this._getStackIndex(
                  this.index,
            ...
            ((i = d.start + d.chunk * g + d.chunk / 2),
              (a = Math.min(l, d.chunk * d.ratio)));
          } else
        ...
        updateElements(t, e, i, a) {
          ...
          for (let i = 0; i < _; ++i) {
            ...
            let y = this.getParsed(i),
              M = (0, s.k)(y[g]),
              k = (_[u] = r.getPixelForValue(y[u], i)),
              w = (_[g] =
                n || M
                  ? o.getBasePixel()
                  : o.getPixelForValue(l ? this.applyStack(o, y, l) : y[g], i));
            ((_.skip = isNaN(k) || isNaN(w) || M),
      ...
      function tu(t, e, i) {
        (i && i.disconnect(),
          "resize" === e &&
            (tl.delete(t),
            tl.size || window.removeEventListener("resize", td)));
      }
      function tg(t, e, i) {
        let a = t.canvas,
          n = (0, s.L)((e) => {
      ...
      class tk extends tf {
        ...
        _computeLabelSizes(t, e, i) {
          let a,
            ...
            g,
            p,
            { ctx: f, _longestTextCache: m } = this,
            x = [],
            b = [],
          ...
          for (a = 0; a < e; a += _) {
            if (
              ((o = t[a].label),
              (f.font = h = (l = this._resolveTickFontOptions(a)).string),
              (d = m[h] = m[h] || { data: {}, gc: [] }),
              (c = l.lineHeight),
              (u = g = 0),
              (0, s.k)(o) || (0, s.b)(o))
        ...
        getContext(t) {
          ...
          if (t >= 0 && t < a.length) {
            ...
            return (
              i.$context ||
              ((e = this.getContext()),
              (i.$context = (0, s.j)(e, { tick: i, index: t, type: "tick" })))
            );
          }
          return (
            this.$context ||
        ...
        _computeGridLineItems(t) {
          ...
          if ("top" === b)
            ...
            ((l = (r = e - S) - k), (d = t.left), (u = t.right));
          }
          let A = (0, s.v)(m.ticks.maxTicksLimit, M),
            L = Math.max(1, Math.ceil(M / A));
          for (i = 0; i < M; i += L) {
        ...
        _computeLabelItems(t) {
          ...
          if ("top" === f)
            ...
            let t = this._getYAxisLabelAlignment(k);
            ((o = t.textAlign), (n = t.x));
          } else if ("right" === f) {
            let t = this._getYAxisLabelAlignment(k);
            ((o = t.textAlign), (n = t.x));
          } else if ("x" === g) {
            if ("center" === f) r = (t.top + t.bottom) / 2 + w;
            else if ((0, s.i)(f)) {
            ...
            if ("center" === f) n = (t.left + t.right) / 2 - w;
            else if ((0, s.i)(f)) {
              let t = Object.keys(f)[0],
                e = f[t];
                  ...
                  (u =
                    "top" === f
                      ? "near" === v || 0 !== D
                        ? -c * d + d / 2
                        : "center" === v
                          ? -A.highest.height / 2 - p * d + d
                          : -A.highest.height + d / 2
                      : "near" === v || 0 !== D
                        ? d / 2
                        : "center" === v
                          ? A.highest.height / 2 - p * d
                          : A.highest.height - c * d),
                  M && (u *= -1),
                  0 === D ||
                    g.showLabelBackdrop ||
                    (n += (d / 2) * Math.sin(D)))
        ...
        drawTitle() {
          ...
          let {
            ...
            let n,
              r,
              o,
              { top: l, left: h, bottom: d, right: c, chart: u } = t,
      ...
      class tw {
        ...
        register(t) {
          ...
          "id" in (e = a) && "defaults" in e && (i = this.register(a));
          let n = this.items,
            r = t.id,
            o = this.scope + "." + r;
          ...
          return (
            r in n ||
              ...
              (function (t, e, i) {
                var a, n;
                let r = (0, s.a4)(Object.create(null), [
                  i ? s.d.get(i) : {},
                  s.d.get(e),
                  t.defaults,
                ]);
                (s.d.set(e, r),
                  t.defaultRoutes &&
                    ((a = e),
                    Object.keys((n = t.defaultRoutes)).forEach((t) => {
                      let e = t.split("."),
                        i = e.pop(),
                        r = [a].concat(e).join("."),
                        o = n[t].split("."),
      ...
      class tP {
        constructor() {
          ((this.controllers = new tw(y, "datasets", !0)),
            (this.elements = new tw(tf, "elements")),
            (this.plugins = new tw(Object, "plugins")),
            (this.scales = new tw(tk, "scales")),
      ...
      function tz(t, e) {
        let i = tF.get(t);
        return (i || ((i = e()), tF.set(t, i), tI.add(i)), i);
      }
      let tR = (t, e, i) => {
        let a = (0, s.f)(e, i);
        void 0 !== a && t.add(a);
      ...
      class tV {
        constructor(t) {
          ((this._config = (function (t) {
            return (((t = t || {}).data = tE(t.data)), tO(t), t);
          })(t)),
      ...
      function tJ(t, e, i, a, n, r) {
        ...
        if ((t.beginPath(), r)) {
          let e = (D + S) / 2;
          if ((t.arc(o, l, u, D, e), t.arc(o, l, u, e, S), y > 0)) {
            let e = tK(P, S, o, l);
          ...
          if ((t.lineTo(i.x, i.y), k > 0)) {
            let e = tK(A, T, o, l);
            t.arc(e.x, e.y, k, _ + s.H, T + Math.PI);
          }
          let a = (_ - k / g + (b + M / g)) / 2;
          if (
            (t.arc(o, l, g, _ - k / g, a, !0),
            t.arc(o, l, g, a, b + M / g, !0),
            M > 0)
          ) {
            let e = tK(C, L, o, l);
            t.arc(e.x, e.y, M, L + Math.PI, b - s.H);
          }
          let n = tK(w, b, o, l);
                ...
                h.selfJoin &&
                  ...
                  (function (t, e, i) {
                    let {
                      ...
                      { borderWidth: d, borderJoinStyle: c } = h,
                      u = Math.min(d / o, (0, s.al)(a - i));
                    if (
                      (t.beginPath(),
                      t.arc(n, r, o - d / 2, a + u / 2, i - u / 2),
                      l > 0)
                    ) {
                      let e = Math.min(d / l, (0, s.al)(a - i));
                      t.arc(n, r, l + d / 2, i - e / 2, a + e / 2, !0);
                    } else {
                      let e = Math.min(d / 2, o * (0, s.al)(a - i));
                      if ("round" === c)
                        t.arc(n, r, e, i - s.P / 2, a + s.P / 2, !0);
                      else if ("bevel" === c) {
                        let o = 2 * e * e,
                          l = -o * Math.cos(i + s.P / 2) + n,
                          h = -o * Math.sin(i + s.P / 2) + r,
                          d = o * Math.cos(a + s.P / 2) + n,
                          c = o * Math.sin(a + s.P / 2) + r;
                        (t.lineTo(l, h), t.lineTo(d, c));
                      }
                    }
                    (t.closePath(),
                      t.moveTo(0, 0),
      ...
      function t5(t, e, i, a) {
        ...
        for (n = 0; n <= g; ++n)
          (r = l[(c + (m ? g - n : n)) % d]).skip ||
            ...
            (o = r));
        return (
          u && p(t, o, (r = l[(c + (m ? g : 0)) % d]), m, h.stepped),
          !!u
        );
      }
      function t3(t, e, i, s) {
      ...
      class t7 extends tf {
        ...
        updateControlPoints(t, e) {
          ...
          if (
            ...
            ((0, s.an)(this._points, i, t, a, e), (this._pointsUpdated = !0));
          }
        }
        set points(t) {
          ((this._points = t),
        ...
        get segments() {
          return (
            this._segments ||
            (this._segments = (0, s.ao)(this, this.options.segment))
          );
        }
        first() {
          let t = this.segments,
        ...
        interpolate(t, e) {
          let i,
            ...
            r = t[e],
            o = this.points,
            l = (0, s.ap)(this, { property: e, start: r, end: r });
          if (!l.length) return;
          let h = [],
            d = n.stepped
              ? s.aq
      ...
      function ei(t, e, i, a) {
        ...
        return (
          o &&
          (n || (0, s.ak)(e, o.left, o.right)) &&
          (r || (0, s.ak)(i, o.top, o.bottom))
        );
      }
      function es(t, e) {
        ...
        let a = (function (t) {
            ...
            if ((0, s.g)(i)) {
              var n,
                r = e,
                o = i;
              let t = r.getDatasetMeta(o);
              return t && r.isDatasetVisible(o) ? t.dataset : null;
            }
            if ("stack" === i)
              return (function (t) {
                ...
                return new t7({ points: n, options: {} });
              })(t);
            if ("shape" === i) return !0;
            let l = ((n = t).scale || {}).getPointPositionForValue
              ? (function (t) {
                  let e,
                    { scale: i, fill: a } = t,
                    n = i.options,
                    r = i.getLabels().length,
                    o = n.reverse ? i.max : i.min,
                    l =
                      "start" === a
                        ? o
                        : "end" === a
                    ...
                    h = [];
                  if (n.grid.circular) {
                    let t = i.getPointPositionForValue(0, o);
                    return new eg({
                      x: t.x,
                      y: t.y,
                      radius: i.getDistanceFromCenterForValue(l),
                    });
                  }
                  for (let t = 0; t < r; ++t)
                    h.push(i.getPointPositionForValue(t, l));
                  return h;
                })(n)
              : (function (t) {
                  let e,
            ...
            return l instanceof eg ? l : ec(l, a);
          })(e),
          { chart: n, index: r, line: o, scale: l, axis: h } = e,
          d = o.options,
          c = d.fill,
          u = d.backgroundColor,
          { above: g = u, below: p = u } = c || {},
          f = n.getDatasetMeta(r),
          m = (0, s.ah)(n, f);
        a &&
          o.points.length &&
          ((0, s.Y)(t, i),
      ...
      function ex(t, e) {
        ...
        for (let { source: e, target: h, start: d, end: c } of (function (
          t,
          e,
          i,
        ) {
          ...
          for (let t of a) {
            let { start: a, end: l } = t;
            l = eh(a, l, n);
            let h = el(i, n[a], n[l], t.loop);
            if (!e.segments) {
              o.push({ source: t, target: h, start: n[a], end: n[l] });
              continue;
            }
            for (let a of (0, s.ap)(e, h)) {
              let e = el(i, r[a.start], r[a.end], a.loop);
              for (let r of (0, s.az)(t, n, e))
                o.push({
                  source: r,
                  target: a,
                  start: { [i]: ed(h, e, "start", Math.max) },
                  end: { [i]: ed(h, e, "end", Math.min) },
                });
            }
          }
          return o;
          ...
          (t.save(),
            ...
            t.beginPath());
          let p = !!i.pathSegment(t, e);
          if (g) {
            p ? t.closePath() : eb(t, a, c, n);
            let e = !!a.pathSegment(t, h, { move: p, reverse: !0 });
            (s = p && e) || eb(t, a, d, n);
          }
              ...
              r &&
                ...
                (o = {
                  ...
                  fill: (function (t, e, i) {
                    ...
                    if ((0, s.i)(l)) return !isNaN(l.value) && l;
                    let h = parseFloat(l);
                    return (0, s.g)(h) && Math.floor(h) === h
                      ? ((a = l[0]),
                        (n = e),
                        (r = h),
                        (o = i),
      ...
      class eM extends tf {
        ...
        fit() {
          ...
          let n = i.labels,
            ...
            { boxWidth: h, itemHeight: d } = ev(n, o);
          ((a.font = r.string),
            this.isHorizontal()
        ...
        _fitCols(t, e, i, s) {
          ...
          return (
            this.legendItems.forEach((t, n) => {
              var f, m, x, b, _, v, y, M, k, w, P, D;
              let S,
                C,
                { itemWidth: A, itemHeight: L } =
                  ((f = i),
                  (m = e),
                  (x = a),
                  (b = t),
                  (_ = s),
                  {
                    itemWidth:
                      ...
                      y + M.size / 2 + k.measureText(S).width),
                    itemHeight:
                      ((w = _),
                      (P = b),
                      (D = m.lineHeight),
                      (C = w),
                      "string" != typeof P.text && (C = ek(P, D)),
                      C),
                  });
              (n > 0 &&
                u + L + 2 * r > h &&
                ...
                p++,
                (c = u = 0)),
                (o[n] = { left: g, top: u, col: p, width: A, height: L }),
                (c = Math.max(c, A)),
                (u += L + r));
            }),
            (d += c),
        ...
        adjustHitBoxes() {
          ...
          let t = this._computeTitleHeight(),
            ...
            r = (0, s.aA)(n, this.left, this.width);
          if (this.isHorizontal()) {
            let n = 0,
        ...
        _draw() {
          let t,
            { options: e, columnSizes: i, lineWidths: a, ctx: n } = this,
            { align: r, labels: o } = e,
            l = s.d.color,
            h = (0, s.aA)(e.rtl, this.left, this.width),
            d = (0, s.a0)(o.font),
            { padding: c } = o,
            u = d.size,
            g = u / 2;
          (this.drawTitle(),
            ...
            (n.lineWidth = 0.5),
            (n.font = d.string));
          let { boxWidth: p, boxHeight: f, itemHeight: m } = ev(o, u),
            x = function (t, e, i) {
              ...
              if (
                ...
                let r = {
                  ...
                  l = h.xPlus(t, p / 2);
                (0, s.aE)(n, r, l, e + g, o.pointStyleWidth && p);
              } else {
                let r = e + Math.max((u - f) / 2, 0),
                  o = h.leftForLtr(t, p),
                  l = (0, s.ay)(i.borderRadius);
                (n.beginPath(),
                  Object.values(l).some((t) => 0 !== t)
                    ? (0, s.aw)(n, { x: o, y: r, w: p, h: f, radius: l })
                    : n.rect(o, r, p, f),
                  n.fill(),
                  0 !== a && n.stroke());
              }
          ...
          ((t = _
            ...
            (0, s.aB)(this.ctx, e.textDirection));
          let y = m + c;
          (this.legendItems.forEach((l, u) => {
            ...
            if (
              ...
              x(h.x(k), w, l),
              (k = (0, s.aC)(m, k + p + g, _ ? k + M : this.right, e.rtl)),
              b(h.x(k), w, l),
              _)
            )
              t.x += M + c;
            ...
            (0, s.aD)(this.ctx, e.textDirection));
        }
        drawTitle() {
          let t,
            e = this.options,
            ...
            n = (0, s.E)(i.padding);
          if (!i.display) return;
          let r = (0, s.aA)(e.rtl, this.left, this.width),
            o = this.ctx,
            l = i.position,
            h = a.size / 2,
            d = n.top + h,
        ...
        _getLegendItemAt(t, e) {
          ...
          if (
            ...
            for (i = 0, n = this.legendHitBoxes; i < n.length; ++i)
              if (
                ((a = n[i]),
                (0, s.ak)(t, a.left, a.left + a.width) &&
                  (0, s.ak)(e, a.top, a.top + a.height))
              )
        ...
        handleEvent(t) {
          ...
          if ("mousemove" === t.type || "mouseout" === t.type) {
            let e = this._hoveredItem,
              i = ey(e, n);
            (e && !i && (0, s.Q)(a.onLeave, [t, e, this], this),
              (this._hoveredItem = n),
              n && !i && (0, s.Q)(a.onHover, [t, n, this], this));
          } else n && (0, s.Q)(a.onClick, [t, n, this], this);
        }
      }
      function ek(t, e) {
      ...
      var ew = {
        ...
        _element: eM,
        start(t, e, i) {
          let s = (t.legend = new eM({ ctx: t.ctx, options: i, chart: t }));
      ...
      function eD(t, e) {
        return (
          e && ((0, s.b)(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
          t
        );
      }
      function eS(t) {
      ...
      class eI extends tf {
        ...
        getTitle(t, e) {
          let { callbacks: i } = e,
            s = eF(i, "beforeTitle", this, t),
            a = eF(i, "title", this, t),
            n = eF(i, "afterTitle", this, t),
            r = [];
          return ((r = eD(r, eS(s))), (r = eD(r, eS(a))), (r = eD(r, eS(n))));
        }
        getBeforeBody(t, e) {
          return eD([], eS(eF(e.callbacks, "beforeBody", this, t)));
        }
        getBody(t, e) {
          let { callbacks: i } = e,
            a = [];
          return (
            (0, s.F)(t, (t) => {
              let e = { before: [], lines: [], after: [] },
                s = eO(i, t);
              (eD(e.before, eS(eF(s, "beforeLabel", this, t))),
                eD(e.lines, eF(s, "label", this, t)),
                eD(e.after, eS(eF(s, "afterLabel", this, t))),
                a.push(e));
            }),
            a
          );
        ...
        getAfterBody(t, e) {
          return eD([], eS(eF(e.callbacks, "afterBody", this, t)));
        }
        getFooter(t, e) {
          let { callbacks: i } = e,
            s = eF(i, "beforeFooter", this, t),
            a = eF(i, "footer", this, t),
            n = eF(i, "afterFooter", this, t),
            r = [];
          return ((r = eD(r, eS(s))), (r = eD(r, eS(a))), (r = eD(r, eS(n))));
        }
        _createItems(t) {
          ...
          return (
            ...
            (0, s.F)(h, (e) => {
              ...
              (r.push(eF(i, "labelColor", this, e)),
                o.push(eF(i, "labelPointStyle", this, e)),
                l.push(eF(i, "labelTextColor", this, e)));
            }),
            (this.labelColors = r),
        ...
        update(t, e) {
          let i,
            ...
            n = [];
          if (a.length) {
            let t = eP[s.position].call(this, a, this._eventPosition);
            ...
            let e = (this._size = eC(this, s)),
              r = Object.assign({}, t, e),
              o = eA(this.chart, s, r),
              l = eL(s, r, o, this.chart);
        ...
        drawTitle(t, e, i) {
          let a,
            ...
            l = o.length;
          if (l) {
            let h = (0, s.aA)(i.rtl, this.x, this.width);
            for (
              r = 0,
                t.x = eT(this, i.titleAlign, i),
        ...
        _drawColorBox(t, e, i, a, n) {
          ...
          if (n.usePointStyle) {
            ...
            let e = a.leftForLtr(u, h),
              ...
              o = (0, s.ay)(r.borderRadius);
            Object.values(o).some((t) => 0 !== t)
              ? (t.beginPath(),
                (t.fillStyle = n.multiKeyBackground),
                (0, s.aw)(t, { x: e, y: p, w: h, h: l, radius: o }),
                t.fill(),
                t.stroke(),
                (t.fillStyle = r.backgroundColor),
                t.beginPath(),
                (0, s.aw)(t, { x: i, y: p + 1, w: h - 2, h: l - 2, radius: o }),
                t.fill())
              : ((t.fillStyle = n.multiKeyBackground),
                t.fillRect(e, p, h, l),
        ...
        drawBody(t, e, i) {
          let a,
            ...
            b = x.lineHeight,
            _ = 0,
            v = (0, s.aA)(i.rtl, this.x, this.width),
            y = function (i) {
              (e.fillText(i, v.x(t.x + _), t.y + b / 2), (t.y += b + c));
            },
            M = v.textAlign(u);
          for (
            e.textAlign = u,
            ...
            for (
              a = d[r],
                ...
                g &&
                  ...
                  (b = Math.max(x.lineHeight, p))),
                o = 0,
                h = n.length;
              o < h;
              ++o
            )
              (y(n[o]), (b = x.lineHeight));
            (0, s.F)(a.after, y);
          }
          ((_ = 0),
            (b = x.lineHeight),
            (0, s.F)(this.afterBody, y),
            (t.y -= c));
        }
        drawFooter(t, e, i) {
          let a,
            ...
            o = r.length;
          if (o) {
            let l = (0, s.aA)(i.rtl, this.x, this.width);
            for (
              t.x = eT(this, i.footerAlign, i),
        ...
        _updateAnimationTarget(t) {
          let e = this.chart,
            ...
            a = i && i.y;
          if (s || a) {
            let i = eP[t.position].call(
              this,
              this._active,
              this._eventPosition,
            );
            if (!i) return;
            let n = (this._size = eC(this, t)),
      ...
      var ez = {
        ...
        positioners: eP,
        afterInit(t, e, i) {
          i && (t.tooltip = new eI({ chart: t, options: i }));
        },
        beforeUpdate(t, e, i) {
      ...
      let eR = (t, e, i, s) => (
        ...
        eV = (t, e) => (null === t ? null : (0, s.S)(Math.round(t), 0, e));
      function eN(t) {
      ...
      class eB extends tk {
        static id = "category";
        static defaults = { ticks: { callback: eN } };
        constructor(t) {
          (super(t),
      ...
      function eH(t, e, { horizontal: i, minRotation: a }) {
        let n = (0, s.t)(a),
      ...
      class eW extends tk {
        ...
        buildTicks() {
          let t = this.options,
            ...
            a = (function (t, e) {
              let i,
                ...
                w = (v - _) / (f + 1),
                P = (0, s.aI)((v - _) / b / x) * x;
              if (P < 1e-14 && !y && !M) return [{ value: _ }, { value: v }];
              ((r = Math.ceil(v / P) - Math.floor(_ / P)) > b &&
                (P = (0, s.aI)((r * P) / b / x) * x),
                (0, s.k)(u) || (P = Math.ceil(P * (i = Math.pow(10, u))) / i),
                "ticks" === l
                  ? ((a = Math.floor(_ / P) * P), (n = Math.ceil(v / P) * P))
                  : ((a = _), (n = v)),
                y && M && h && (0, s.aJ)((c - d) / h, P / 1e3)
                  ? ((r = Math.round(Math.min((c - d) / P, p))),
                    (P = (c - d) / r),
                    (a = d),
                    (n = c))
                  : k
                    ? ((a = y ? d : a),
                      (P = ((n = M ? c : n) - a) / (r = g - 1)))
                    : ((r = (n - a) / P),
                      (r = (0, s.aK)(r, Math.round(r), P / 1e3)
                        ? Math.round(r)
                        : Math.ceil(r))));
              let D = Math.max((0, s.aL)(P), (0, s.aL)(a));
              ((a =
                Math.round(a * (i = Math.pow(10, (0, s.k)(u) ? D : u))) / i),
                (n = Math.round(n * i) / i));
              let S = 0;
              for (
                y &&
                ...
                let t = Math.round((a + S * P) * i) / i;
                if (M && t > c) break;
                o.push({ value: t });
              }
              return (
                M && m && n !== c
                  ? o.length && (0, s.aK)(o[o.length - 1].value, c, eH(c, w, t))
          ...
          return (
            "ticks" === t.bounds && (0, s.aH)(a, this, "value"),
            t.reverse
      ...
      class ej extends eW {
        static id = "linear";
        static defaults = { ticks: { callback: s.aM.formatters.numeric } };
        determineDataLimits() {
      ...
      let e$ = (t) => Math.floor((0, s.aN)(t)),
        eU = (t, e) => Math.pow(10, e$(t) + e);
      function eY(t) {
        return 1 == t / Math.pow(10, e$(t));
      }
      function eQ(t, e, i) {
        let s = Math.pow(10, i),
          a = Math.floor(t / s);
      ...
      class eG extends tk {
        ...
        static defaults = {
          ticks: {
            callback: s.aM.formatters.logarithmic,
            major: { enabled: !0 },
          },
        };
        constructor(t) {
        ...
        parse(t, e) {
          let i = eW.prototype.parse.apply(this, [t, e]);
          if (0 === i) {
            this._zero = !0;
            return;
          }
        ...
        determineDataLimits() {
          ...
          ((this.min = (0, s.g)(t) ? Math.max(0, t) : null),
            ...
            this._zero &&
              ...
              !(0, s.g)(this._userMin) &&
              (this.min =
                t === eU(this.min, 0) ? eU(this.min, -1) : eU(this.min, 0)),
            this.handleTickRangeOptions());
        }
        handleTickRangeOptions() {
          let { minDefined: t, maxDefined: e } = this.getUserBounds(),
            ...
            a = (e) => (i = t ? i : e),
            n = (t) => (s = e ? s : t);
          (i === s && (i <= 0 ? (a(1), n(10)) : (a(eU(i, -1)), n(eU(s, 1)))),
            i <= 0 && a(eU(s, -1)),
            s <= 0 && n(eU(i, 1)),
            (this.min = i),
            (this.max = s));
        ...
        buildTicks() {
          let t = this.options,
            e = (function (t, { min: e, max: i }) {
              ...
              for (; g < i; )
                (a.push({ value: g, major: eY(g), significand: u }),
                  u >= 10 ? (u = u < 15 ? 15 : 20) : u++,
                  u >= 20 && ((u = 2), (o = ++r >= 0 ? 1 : o)),
                  (g = Math.round((h + c + u * Math.pow(10, r)) * o) / o));
              let p = (0, s.O)(t.max, g);
              return (a.push({ value: p, major: eY(p), significand: u }), a);
        ...
        configure() {
          let t = this.min;
          (super.configure(),
            (this._startValue = (0, s.aN)(t)),
            (this._valueRange = (0, s.aN)(this.max) - (0, s.aN)(t)));
        }
        getPixelForValue(t) {
          ...
          null === t || isNaN(t))
            ...
            : this.getPixelForDecimal(
                t === this.min
                  ? 0
                  : ((0, s.aN)(t) - this._startValue) / this._valueRange,
              );
        }
        getValueForPixel(t) {
      ...
      class eJ extends eW {
        ...
        static defaults = {
          ...
          grid: { circular: !1 },
          startAngle: 0,
          ticks: { showLabelBackdrop: !0, callback: s.aM.formatters.numeric },
          pointLabels: {
        ...
        setDimensions() {
          let t = (this._padding = (0, s.E)(eX(this.options) / 2)),
        ...
        computeTickLimit() {
          return Math.ceil(this.drawingArea / eX(this.options));
        }
        generateTickLabels(t) {
          (eW.prototype.generateTickLabels.call(this, t),
                ...
                for (let c = 0; c < r; c++) {
                  ...
                  let u = t.getPointPosition(c, t.drawingArea + n[c], l),
                    ...
                    p =
                      ...
                      (d = (0, s.b)(d) ? d : [d]),
                      {
                        w: (0, s.aO)(h, g.string, d),
                        h: d.length * g.lineHeight,
                      });
                  a[c] = p;
                  let f = (0, s.al)(t.getIndexAngle(c) + l),
                    ...
                    for (let o = 0; o < r; o++) {
                      ...
                      let r = (function (t, e, i) {
                        ...
                        let c = t.drawingArea,
                          ...
                          m = t.getPointPosition(e, c + u + p, g),
                          x = Math.round((0, s.U)((0, s.al)(m.angle + s.H))),
                          b =
                            ((a = m.y),
                            (n = f.h),
                            90 === (r = x) || 270 === r
                  ...
                  !(function (t, e, i) {
                    ...
                    if (!(0, s.k)(l)) {
                      ...
                      Object.values(i).some((t) => 0 !== t)
                        ? (t.beginPath(),
                          (0, s.aw)(t, { x: d, y: c, w: u, h: g, radius: i }),
                          t.fill())
                        : t.fillRect(d, c, u, g);
                    }
                  })(i, r, e);
      ...
      function e5(t, e, i, s) {
        let a = e0.length;
        for (let n = e0.indexOf(t); n < a - 1; ++n) {
          let t = eZ[e0[n]],
            a = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
          if (t.common && Math.ceil((i - e) / (a * t.size)) <= s) return e0[n];
        }
        return e0[a - 1];
      }
      function e3(t, e, i) {
      ...
      class e4 extends tk {
        ...
        parse(t, e) {
          return void 0 === t ? null : e2(this, t);
        }
        beforeLayout() {
          (super.beforeLayout(),
            (this._cache = { data: [], labels: [], all: [] }));
        ...
        buildTicks() {
          ...
          return (
            (this._unit =
              e.unit ||
              (i.autoSkip
                ? e5(e.minUnit, this.min, this.max, this._getLabelCapacity(n))
                : (function (t, e, i, s, a) {
                    for (let n = e0.length - 1; n >= e0.indexOf(i); n--) {
                      let i = e0[n];
                      if (eZ[i].common && t._adapter.diff(a, s, i) >= e - 1)
                        return i;
                    }
                    return e0[i ? e0.indexOf(i) : 0];
                  })(this, o.length, e.minUnit, this.min, this.max))),
            (this._majorUnit =
              i.major.enabled && "year" !== this._unit
                ? (function (t) {
                    for (let e = e0.indexOf(t) + 1, i = e0.length; e < i; ++e)
                      if (eZ[e0[e]].common) return e0[e];
                  })(this._unit)
                : void 0),
            this.initOffsets(a),
            t.reverse && o.reverse(),
            e6(this, o, this._majorUnit)
          );
        }
        afterAutoSkip() {
        ...
        _generate() {
          let t,
            ...
            r = this.options,
            o = r.time,
            l = o.unit || e5(o.minUnit, a, n, this._getLabelCapacity(a)),
          ...
          for (t = g, e = 0; t < n; t = +i.add(t, h, l), e++) e3(u, t, p);
          return (
            (t === n || "ticks" === r.bounds || 1 === e) && e3(u, t, p),
            Object.keys(u)
              .sort(e1)
              .map((t) => +t)
          );
        ...
        getLabelTimestamps() {
          ...
          for (t = 0, e = s.length; t < e; ++t) i.push(e2(this, s[t]));
          return (this._cache.labels = this._normalized
            ? i
            : this.normalize(i));
        }
        normalize(t) {
          return (0, s._)(t.sort(e1));
        }
      }
      function e7(t, e, i) {
        let a,
      ...
      class e8 extends e4 {
        ...
        initOffsets() {
          ...
          ((this._minPos = e7(e, this.min)),
            (this._tableRange = e7(e, this.max) - this._minPos),
            super.initOffsets(t));
        }
        buildLookupTable(t) {
          let e,
        ...
        getDecimalForValue(t) {
          return (e7(this._table, t) - this._minPos) / this._tableRange;
        }
        getValueForPixel(t) {
          let e = this._offsets,
            i = this.getDecimalForPixel(t) / e.factor - e.end;
          return e7(this._table, i * this._tableRange + this._minPos, !0);
        }
      }
    },
  },
